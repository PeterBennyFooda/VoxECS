...
vec4 GetTextureLayer()
{
    // Normalize the y position (assume y ranges from 0 to maxHeight)
//    float normalizedHeight = FragPos.y / maxHeight;
//
//    // Select a texture layer based on the normalized height
//    int textureLayer;
//    float offset = 0.49;
//    float bedrock = (2.0-offset) / maxHeight;
//    float stone = (5.0-offset) / maxHeight;
//    float sandstone = (10.0-offset) / maxHeight;
//
//    if (normalizedHeight < bedrock) 
//    {
//        textureLayer = 0;  // bedrock texture
//    } 
//    else if (normalizedHeight < stone) 
//    {
//        textureLayer = 1;  // stone texture
//    } 
//    else if (normalizedHeight < sandstone) 
//    {
//        textureLayer = 2;  // sandstone texture
//    } 
//    else 
//    {
//        textureLayer = 3;  // sand texture
//    }

    // Sample the appropriate texture layer from the texture array
    return texture(textureArray, vec3(TexCoord, 0));
}
